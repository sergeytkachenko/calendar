...
$.fn.zabuto_calendar = function (options) {
    ...
    var Calendar = function($el) {
        ...
        /**
         * Переходит к указаной дате.
         * @param {Date} date
         */
        this.getToDate = function (year, month) {
            opts.year = year;
            opts.month = month;
            $calendarElement.data('initYear', year);
            $calendarElement.data('initMonth', month);
        ...
        this.setData = function (data) {
            opts.data = data;
            $calendarElement.data('jsonData', data);
        }
    }
